				...
				if 'mac' in nm[h]['addresses']:
							for x in device_list: 
								if x in nm[h]['addresses']['mac']:
									return_dict[nm[h]['vendor'][nm[h]['addresses']['mac']]] = {'host' : nm[h]['addresses']['ipv4'], 'state' : nm[h]['status']['state'], 'mac' : nm[h]['addresses']['mac'], 'marca' : 'Hasar', 'modelo' : '715v2', 'driver' : 'File'}
