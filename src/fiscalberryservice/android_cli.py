...
"""
Android Service Entry Point - Fiscalberry CLI

Entry point para el servicio Android foreground.
Integra con el sistema Android (notificaciones, battery exemption, etc.)
y delega la lógica real a fiscalberry_cli.main.
"""
import os
import sys

# Add fiscalberry to path
...
def run_service():
    ...
    try:
        from fiscalberry_cli.main import main
